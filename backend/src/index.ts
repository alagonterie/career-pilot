// Trigger backend deployment pipeline
...
// Recruiter Contact Request Endpoint (forwards details to Jane via Telegram)
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    if (allowedChatId && bot) {
      ...
      res.json({ success: true, message: 'Message sent to Jane via Telegram.' });
    } else {
