      ...
      try {
        ...
        if (statusData.bootstrapped) {
          ...
          if (isAdministration) {
            ...
            // For recruiters, fallback to beautiful mock/simulated profile of Alexander
            loadMockData();
          }
        }
      } catch (err) {
      ...
      <div className="dashboard-grid" style={{ marginTop: '24px' }}>
        ...
        <div className="card" style={{ gridColumn: 'span 8' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginTop: '4px', marginBottom: '20px' }}>
            Real-time status tracking of Alexander's job search assistant executing workflows in Docker sandboxes.
          </p>
        ...
        <div className="card" id="contact" style={{ gridColumn: 'span 4' }}>
          <h3 className="card-title">✉️ Contact Alexander</h3>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginTop: '4px', marginBottom: '20px' }}>
            Interested in discussing opportunities? Send details directly to Alexander's Telegram client.
          </p>
          ...
          {contactSuccess ? (
            <div style={{
              ...
              <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', marginTop: '8px', lineHeight: '1.4' }}>
                Alexander has been alerted via his Telegram notification client. Expect a prompt response.
              </p>
