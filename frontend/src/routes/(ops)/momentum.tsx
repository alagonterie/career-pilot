...
// rename to "My Job Pipeline" (/pipeline). Old links (bookmarks, /dashboard
// outcome deep-links from pre-rename sessions) land here; the ?app= drawer param
// is carried so deep-links keep opening the right card.
