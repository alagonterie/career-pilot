 ...
 */
export function FunnelCompact({ apps }: { apps: FunnelApplication[] }) {
    ...
    <div data-testid="funnel-compact" className="flex flex-col gap-3">
      <div className="grid grid-cols-5 gap-1.5">
        {STAGES.map((s) => (
          ...
          >
            <span className="font-mono text-lg font-semibold tabular-nums text-foreground">{counts[s.stage] ?? 0}</span>
