...
const ONBOARDING_SENTINEL = [
  ...
  '',
  'The turn you capture master_resume, ALSO WRITE `protected_terms` by calling',
  '`update_profile_field` (field `protected_terms`, value a JSON-array string) —',
  "the candidate's past employer names + any personal project/codenames in the",
  'résumé. It is NOT auto-populated; you persist it via the tool (no need to ask —',
  "it isn't its own onboarding question). These stay visible (never anonymized) on",
  "the public interview kits because they are the candidate's OWN résumé. Refresh",
  'it whenever the résumé changes or the candidate asks you to adjust it.',
  '',
