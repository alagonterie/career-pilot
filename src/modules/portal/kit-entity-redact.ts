...
const SYSTEM_PROMPT = [
  ...
  'Return ONLY a JSON array of the exact substrings to redact. Include ONLY terms',
  'you are confident name ONE specific organization:',
  "- that company's product NAMES, internal project names, codenames, internal",
  '  tools, or branded services;',
  '- its named teams, named offices/locations, or named people.',
  'EXCLUDE — keep these, they do NOT identify a company:',
  '- widely-known generic technologies: programming languages, protocols,',
  '  databases, cloud platforms, common open-source frameworks.',
  '- generic INDUSTRY and technical vocabulary: standard acronyms, architecture',
  '  and methodology names, discipline and role titles, and product CATEGORIES',
  "  (a kind of system) as opposed to one company's product NAME.",
  '- the [REDACTED:...] token and any [..._REDACTED] placeholders.',
  "- the candidate's OWN past employers, projects, and experience (their résumé).",
  'Do NOT redact a term just because it is an acronym, is capitalized, or looks',
  'unfamiliar — generic industry vocabulary is safe. When a term is plausibly',
  'generic, KEEP it; redact only a clear, specific organizational brand.',
