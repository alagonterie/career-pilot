...
- `NEXT_PUBLIC_CANDIDATE_NAME`: Full name of the candidate (e.g. *Jane Doe*).
...
5. This is done on-the-fly and does not write to the persistent application database, serving as a zero-risk, high-impact demonstration of Jane's AI engineering skills.
