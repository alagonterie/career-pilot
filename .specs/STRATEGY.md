...
**36.3–36.5** are drilled in when reached (the §24.35 pattern): error-boundary + backend-down fallback, reduced-motion + reconnect audit, meta/OG/favicon/404 — each a drill-in + build with its own DoD.
