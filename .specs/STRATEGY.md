...
**Spec deltas (this drill-in).** This §24.72 (the two-tier model + D1–D6 + the r2 build plan + staging + DoD); PORTAL §5.6 (the `/work` Download-PDF build note → the react-pdf infra + the Tier-2 cross-sell); §5.3's tailored-download note lands with the 9.4b-r2 build. Memory: [[status_current]].
