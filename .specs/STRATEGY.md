...
**Config keys (defaults.json):** `portal_observability_cache_ms` 30000, `arch_provider_error_rate_degraded` 0.25. No new inspector knobs (stable infra thresholds; add later only if a tuning need surfaces).
